...
-- Dumping data for table groupomania.roles: ~1 rows (approximately)
DELETE FROM `roles`;
INSERT INTO `roles` (`id`, `name`, `createdAt`, `updatedAt`) VALUES
	(0, 'user', '2022-03-31 13:46:14', '2022-03-31 13:46:15'),
	(1, 'admin', '2022-03-31 13:46:37', '2022-03-31 13:46:38');

-- Dumping data for table groupomania.users: ~0 rows (approximately)
DELETE FROM `users`;
...
-- Dumping data for table groupomania.user_roles: ~0 rows (approximately)
DELETE FROM `user_roles`;
INSERT INTO `user_roles` (`createdAt`, `updatedAt`, `roleId`, `userId`) VALUES
	('2022-08-08 02:07:44', '2022-08-08 02:07:44', 0, 1),
